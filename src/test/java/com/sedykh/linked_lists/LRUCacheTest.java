...
//        Output: [null, null, null, 1, null, -1, null, -1, 3, 4]
        ...
        cache.put(3, 3);
        Assertions.assertEquals(NOT_FOUND, cache.get(2));
        cache.put(4, 4);
        Assertions.assertEquals(NOT_FOUND, cache.get(1));
...
//[[2],[2,1],[3,2],[3],[2],[4,3],[2],[3],[4]]
        ...
        cache.put(4, 3);
        Assertions.assertEquals(1, cache.get(2));
        Assertions.assertEquals(NOT_FOUND, cache.get(3));
...
//                Assertions.assertEquals(expectedResults[i], result);
            ...
            if (lruCache.lruNode != lruCache.mruNode && lruCache.lruNode.next == null) {
