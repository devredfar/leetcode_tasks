...
class FindCriticalAndPseudoCriticalEdgesTest {
    ...
    class MySolution_Kruskals {
        ...
        void findCriticalAndPseudoCriticalEdges1() {
            ...
            //when
            List<List<Integer>> actual = new FindCriticalAndPseudoCriticalEdges.MySolution_Kruskals().findCriticalAndPseudoCriticalEdges(5, edges);
            //then
        ...
        void findCriticalAndPseudoCriticalEdges3() {
            ...
            //when
            List<List<Integer>> actual = new FindCriticalAndPseudoCriticalEdges.MySolution_Kruskals().findCriticalAndPseudoCriticalEdges(6, edges);
            //then
            TestUtils.equalsInAnyOrder(actual, expected);
        }
        ...
        void findCriticalAndPseudoCriticalEdges4() {
            ...
            //when
            List<List<Integer>> actual = new FindCriticalAndPseudoCriticalEdges.MySolution_Kruskals().findCriticalAndPseudoCriticalEdges(3, edges);
            //then
            TestUtils.equalsInAnyOrder(actual, expected);
        }
        ...
        void findCriticalAndPseudoCriticalEdges5() {
            ...
            //when
            List<List<Integer>> actual = new FindCriticalAndPseudoCriticalEdges.MySolution_Kruskals().findCriticalAndPseudoCriticalEdges(14, edges);
            //then
            TestUtils.equalsInAnyOrder(actual, expected);
        }
    }
    ...
    class MySolution_Prims {
        ...
        void findCriticalAndPseudoCriticalEdges1() {
            ...
            var expected = TestUtils.parseToList("[[0,1],[2,3,4,5]]");
            //when
            List<List<Integer>> actual = new FindCriticalAndPseudoCriticalEdges.MySolution_Prims().findCriticalAndPseudoCriticalEdges(5, edges);
            //then
            TestUtils.equalsInAnyOrder(actual, expected);
        }
        ...
        void findCriticalAndPseudoCriticalEdges3() {
            ...
            var expected = TestUtils.parseToList("[[3],[0,1,2,4,5,6]]");
            //when
            List<List<Integer>> actual = new FindCriticalAndPseudoCriticalEdges.MySolution_Prims().findCriticalAndPseudoCriticalEdges(6, edges);
            //then
            TestUtils.equalsInAnyOrder(actual, expected);
        }
        ...
        void findCriticalAndPseudoCriticalEdges4() {
            ...
            var expected = TestUtils.parseToList("[[0,1],[]]");
            //when
            List<List<Integer>> actual = new FindCriticalAndPseudoCriticalEdges.MySolution_Prims().findCriticalAndPseudoCriticalEdges(3, edges);
            //then
            TestUtils.equalsInAnyOrder(actual, expected);
        }
        ...
        void findCriticalAndPseudoCriticalEdges5() {
            ...
            var expected = TestUtils.parseToList("[[13,16,45,55,57,58,61,89],[10,15,23,25,28,32,37,39,51,54,70,75,76,85]]");
            //when
            List<List<Integer>> actual = new FindCriticalAndPseudoCriticalEdges.MySolution_Prims().findCriticalAndPseudoCriticalEdges(14, edges);
            //then
            TestUtils.equalsInAnyOrder(actual, expected);
        }
    }
